...
export class CreateSeriesDto {
  ...
  @MaxLength(250, {
    message: 'El campo titulo no puede exceder los 250 caracteres',
  })
  ...
  @MaxLength(5000, {
    message: 'El campo sinopsis no puede exceder los 5000 caracteres',
  })
  ...
  @MaxLength(100, {
    message: 'El campo director no puede exceder los 100 caracteres',
  })
  ...
  @IsDateString(
    {},
    { message: 'El campo fechaEstreno debe ser una fecha válida' },
  )
